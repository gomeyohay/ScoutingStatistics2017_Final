...
namespace WindowsFormsApplication5
{
    ...
    public partial class ScoutingEntities_New : DbContext
    {
        public ScoutingEntities_New()
            : base("name=ScoutingEntities_New")
        {
        }

        public ScoutingEntities_New(string nameOrConnectionString) : base(nameOrConnectionString)
        {
        }
